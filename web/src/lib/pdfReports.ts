  ...
  <div class="bottom-section">
    <div>
      ...
      <div class="terms-box">
        ...
        <ul>
          <li>This consolidated report is generated by Himat Textile — Your Business Guide Across India.</li>
...
export function buildCustomerReportWhatsAppText(data: CustomerReportData): string {
  ...
  text += `━━━━━━━━━━━━━━━━━━━━\n`
  text += `_Generated via Himat Textile — Your Business Guide Across India_`
...
export function buildSupplierInvoiceWhatsAppText(data: SupplierInvoiceData): string {
  ...
  let text = `*HIMAT TEXTILE — YOUR BUSINESS GUIDE ACROSS INDIA*\n`
  text += `🏷️ *SUPPLIER PURCHASE ORDER*\n`
  text += `━━━━━━━━━━━━━━━━━━━━\n`
