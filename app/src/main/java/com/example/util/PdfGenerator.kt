...
object PdfGenerator {
    ...
    fun generateCustomerDayReport(
        ...
        canvas.drawText("HIMAT TEXTILE", textStartX, 38f, paint)

        paint.textSize = 9.5f
        paint.color = goldColor
        paint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.BOLD)
        canvas.drawText("YOUR BUSINESS GUIDE ACROSS INDIA", textStartX, 53f, paint)

        paint.textSize = 8f
        paint.color = Color.rgb(200, 210, 225)
        paint.typeface = Typeface.DEFAULT
        canvas.drawText("Garment Sourcing Agency • Wholesale to Retail Facilitator", textStartX, 68f, paint)
    ...
    fun generateSupplierCopy(
        ...
        paint.color = Color.rgb(200, 210, 225)
        paint.typeface = Typeface.DEFAULT
        canvas.drawText("Official Purchase Order & Spot Procurement Booking Voucher", textStartX, 68f, paint)
